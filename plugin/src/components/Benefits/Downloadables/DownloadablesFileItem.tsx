...
export const FileListItem = ({
  ...
  return (
    <div
      ...
      className={twMerge(
        "hover:dark:bg-neutral-800 dark:bg-neutral-900 text-neutral-500 flex flex-row items-center justify-between gap-x-8 gap-y-2 rounded-xl px-3 py-2 transition-colors",
